...
- [ ] **Phase 3: Always-On Scheduler** - Briefings fire automatically at each location's local time, DST-safe and never duplicated (gaps_found 2026-06-10 — DST transition-band catch-up + exactly-once delivery unmet; see 03-VERIFICATION.md)
...
| 3. Always-On Scheduler | 3/3 | ⚠ Gaps Found (3/5) | 2026-06-10 |

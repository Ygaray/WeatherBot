...
- [x] **UV-05**: The monitor delivers a **pre-warning alert** when UV is approaching the threshold (within the configured lead) and a **threshold-reached alert** when UV crosses it — each **at most once per day per location**, posted to Discord. (Code-complete + unit-green across 15-01/02/03; live once-each-over-a-real-crossing UAT PASSED on host yahir-mint 2026-06-23 — 15-UAT.md Test 2.)
...
| UV-05 | Phase 15 | Complete (15-01/02/03; live crossing UAT passed 2026-06-23) |
